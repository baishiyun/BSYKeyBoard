...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.backgroundColor = [UIColor colorWithRed:153/255.0 green:153/255.0 blue:153/255.0 alpha:1];
...
-(UILabel *)IDCardBoardTitle
{
    if (!_IDCardBoardTitle) {
        ...
        _IDCardBoardTitle.font = [UIFont systemFontOfSize:17];
...
-(UIButton *)finishedBtn
{
    if (!_finishedBtn) {
        ...
        _finishedBtn.frame  =CGRectMake([UIScreen mainScreen].bounds.size.width-100, 0, 100, 44.0);
        _finishedBtn.titleLabel.font = [UIFont systemFontOfSize:25];
